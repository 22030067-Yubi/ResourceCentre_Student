...
public class ResourceCentreTest {
	...
	@Test
	public void testDoReturnChromebook() { // fail("Not yet implemented");
		// Test case 1: Return a loaned out item assertNotNull("Test if there is valid
		// Chromebook arraylist to add to", chromebookList);
		assertNotNull("Test if there is valid chromebook arraylist to add to", chromebookList);
		ResourceCentre.addChromebook(chromebookList, cb1);
		Boolean ok = ResourceCentre.doLoanChromebook(chromebookList, "CB0011", "8-8-2020");
		...
		assertFalse("Test the the return of CB001 fails.", isReturned);
	}
